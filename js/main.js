...
$(window).on('wheel', function(e) {
    ...
    // Touch support (mobile scrolling + page switching)
...
$(document).on('touchend', function (e) {
    ...
    const activeSection = $('.section.active')[0];
    ...
    // Still scrolling inside current section
    if (goingDown && scrollTop < maxScroll) {
        return;
    }

    if (!goingDown && scrollTop > 0) {
        return;
    }
